...
def main(demographic, unit):
    ...
    for i in range(len(dstrs)):
        ...
        query_str = 'SELECT {}, {} FROM {} WHERE orig_id = (?)'.format('HSSAscore',demographic, 'orig')
        result = []
...
demographics = ['pop','pop_over_65','pop_below_10','pop_female','pop_color']
units = ['neighborhood', 'district']
if __name__ == '__main__':
    for unit in units:
        for demographic in demographics:
            main(demographic, unit)